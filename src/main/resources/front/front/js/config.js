...
var indexNav = [
    ...
    // {
    //     name: '发放',
    //     url: './pages/wuzifafang/list.html'
    // },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/wizijuanzenghefenpei/admin/dist/index.html#/login";
