<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='jigou'"  label='机构姓名' prop="jigouName">
               <el-input v-model="ruleForm.jigouName"  placeholder='机构姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='jigou'"  label='机构手机号' prop="jigouPhone">
               <el-input v-model="ruleForm.jigouPhone"  placeholder='机构手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='jigou'" label='机构头像' prop="jigouPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='jigou'"  label='机构邮箱' prop="jigouEmail">
               <el-input v-model="ruleForm.jigouEmail"  placeholder='机构邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 机构 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.jigouName)&& 'jigou'==this.flag){
                             this.$message.error('机构姓名不能为空');
                             return
                         }

                             if( 'jigou' ==this.flag && this.ruleForm.jigouPhone&&(!isMobile(this.ruleForm.jigouPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.jigouPhoto)&& 'jigou'==this.flag){
                             this.$message.error('机构头像不能为空');
                             return
                         }

                             if( 'jigou' ==this.flag && this.ruleForm.jigouEmail&&(!isEmail(this.ruleForm.jigouEmail))){
