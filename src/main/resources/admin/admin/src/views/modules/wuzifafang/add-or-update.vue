    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="发放数量" prop="wuzifafangShuliang">
                       <el-input v-model="ruleForm.wuzifafangShuliang"
                                 placeholder="发放数量" clearable  :readonly="ro.wuzifafangShuliang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="发放数量" prop="wuzifafangShuliang">
                           <el-input v-model="ruleForm.wuzifafangShuliang"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.wuzifafangContent"  label="发放介绍" prop="wuzifafangContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuzifafangContent" label="发放介绍" prop="wuzifafangContent">
        ...
        data() {
            return {
                ...
                ro:{
                    wuziId: false,
                    yonghuId: false,
                    wuzifafangShuliang: false,
                    wuzifafangContent: false,
                    wuzifafangDelete: false,
                    insertTime: false,
                },
                ruleForm: {
                    wuziId: '',
