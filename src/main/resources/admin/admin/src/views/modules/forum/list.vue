...
|| (sessionTable == 'jigou' && scope.row.jigouId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/wizijuanzenghefenpei/upload/forumMuBan.xls"
                        >批量导入物资论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.jigouId = el.jigouId;//---
                            forum.jigouName = el.jigouName;
                            forum.jigouPhone = el.jigouPhone;
                            forum.jigouPhoto = el.jigouPhoto;
                            forum.jigouEmail = el.jigouEmail;
                            forum.createTime = el.createTime;
