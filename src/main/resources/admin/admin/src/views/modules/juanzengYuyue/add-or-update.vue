<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='jigou'">
                    <el-form-item class="select" v-if="type!='info'"  label="机构" prop="jigouId">
                        <el-select v-model="ruleForm.jigouId" :disabled="ro.jigouId" filterable placeholder="请选择机构" @change="jigouChange">
                            <el-option
                                    v-for="(item,index) in jigouOptions"
                                    v-bind:key="item.id"
                                    :label="item.jigouName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='jigou' ">
                    <el-form-item class="input" v-if="type!='info'"  label="机构姓名" prop="jigouName">
                        <el-input v-model="jigouForm.jigouName"
                                  placeholder="机构姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="机构姓名" prop="jigouName">
                            <el-input v-model="ruleForm.jigouName"
                                      placeholder="机构姓名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='jigou' ">
                    <el-form-item class="input" v-if="type!='info'"  label="机构手机号" prop="jigouPhone">
                        <el-input v-model="jigouForm.jigouPhone"
                                  placeholder="机构手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="机构手机号" prop="jigouPhone">
                            <el-input v-model="ruleForm.jigouPhone"
                                      placeholder="机构手机号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='jigou' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jigouPhoto" label="机构头像" prop="jigouPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (jigouForm.jigouPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jigouPhoto" label="机构头像" prop="jigouPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.jigouPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='jigou' ">
                    <el-form-item class="input" v-if="type!='info'"  label="机构邮箱" prop="jigouEmail">
                        <el-input v-model="jigouForm.jigouEmail"
                                  placeholder="机构邮箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="机构邮箱" prop="jigouEmail">
                            <el-input v-model="ruleForm.jigouEmail"
                                      placeholder="机构邮箱" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="jigouId" name="jigouId" type="hidden">
            <input id="wuziId" name="wuziId" type="hidden">
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="物资信息" prop="juanzengYuyueText">
                        <el-input type="textarea"  :readonly="ro.juanzengYuyueText" v-model="ruleForm.juanzengYuyueText" placeholder="物资信息"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.juanzengYuyueText" label="物资信息" prop="juanzengYuyueText">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   juanzengYuyueText: [
                              { required: true, message: '物资信息不能为空', trigger: 'blur' },
                          ],
                   juanzengYuyueShuliang: [
        ...
        created() {
         ...
         this.$http({
             url: `jigou/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.jigouOptions = data.data.list;
            }
         });
         this.$http({
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.jigouChange(data.data.jigouId)
