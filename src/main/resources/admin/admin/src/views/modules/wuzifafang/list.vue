        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/wizijuanzenghefenpei/upload/wuzifafangMuBan.xls"
                        >批量导入发放数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuzifafang','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="wuzifafangShuliang"
                                      header-align="center"
                                      label="发放数量">
                        <template slot-scope="scope">
                            {{scope.row.wuzifafangShuliang}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                ...
                wuziId : null,
                yonghuId : null,
                wuzifafangShuliang : null,
                wuzifafangContent : null,
                wuzifafangDelete : null,
                insertTime : null,
                createTime : null,
            },
            dataList: [],
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'wuzifafang',//当前表表名,
                        sumColum : 'wuzifafang_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'wuzifafang_name',//分组字符串字段
                        // types : 'wuzifafang_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
