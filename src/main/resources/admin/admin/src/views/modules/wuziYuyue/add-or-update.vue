    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="物资信息" prop="wuziYuyueText">
                        <el-input type="textarea"  :readonly="ro.wuziYuyueText" v-model="ruleForm.wuziYuyueText" placeholder="物资信息"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziYuyueText" label="物资信息" prop="wuziYuyueText">
